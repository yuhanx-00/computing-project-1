...
ggplot(summary_percent_cocoa, aes(x = cocoa_percent_category , y = rating)) + 
  geom_boxplot() + 
  facet_wrap(~country_of_bean_origin,nrow=4, scales="free") +
...
```{r}
# first step: Create a new set of columns titled beans, sugar, cocoa_butter, vanilla, letchin, and salt that contain a 1 or 0 representing whether or not that review for the chocolate bar contained that ingredient (1) or not (0).
