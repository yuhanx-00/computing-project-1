...
ggplot(choc_feature_avg_long, aes(x = review_date, y = mean_score, color=feature)) + 
  ...
  labs(x = "year of review", y = "average percentage for each feature", title = "Average Percentage for Each Chocolate Feature by Year", subtitle = "what I found", caption = "plotted by Yuhan Xiao") +
