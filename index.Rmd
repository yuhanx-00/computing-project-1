...
choc_worst_plot <- chocolate %>%
  ...
  theme(panel.grid.major = element_line(color = "black", size = 20),  # major gridlines
    panel.grid.minor = element_line(color = "lightgray", size = 1),  # minor gridlines
...
```{r}
choc_better_plot <- choc_worst_plot +
  geom_violin() 
choc_better_plot
```