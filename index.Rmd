...
7. On average, which category of chocolate percentage is most highly rated? Do these countries mostly agree or are there disagreements?
  - For each country, make a set of four side-by-side boxplots plotting the groups on the x-axis and the ratings on the y-axis. These plots should be faceted by country. <br>
...
summary_percent_cocoa <- chocolate %>%
  select(country_of_bean_origin, cocoa_percent) %>%
...
summary_percent_cocoa$cocoa_percent_category %>%
  factor(as.character())
```